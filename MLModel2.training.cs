...
namespace TempEarthPredition
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\user\source\repos\TempEarthPredition\Average Temperature 1900-2023.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:10,seriesLength:11,trainSize:124,horizon:10,outputColumnName:@"TempC",inputColumnName:@"TempC",confidenceLowerBoundColumn:@"TempC_LB",confidenceUpperBoundColumn:@"TempC_UB");
